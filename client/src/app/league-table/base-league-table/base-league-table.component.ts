...
export class BaseLeagueTableComponent implements OnChanges {
  ...
  fetchTopStats() {
    const leagueTopGoalRequest = this.playerStatService.fetchTopStat(this.selectedLeagueName, this.selectedSeason, 'goals_scored');
    const leagueTopYellowRequest = this.playerStatService.fetchTopStat(this.selectedLeagueName, this.selectedSeason, 'yellow_card');
    const leagueTopRedRequest = this.playerStatService.fetchTopStat(this.selectedLeagueName, this.selectedSeason, 'red_card');

    forkJoin([leagueTopGoalRequest, leagueTopYellowRequest, leagueTopRedRequest]).subscribe({
