...
export class SponsorService {
  ...
  deleteSponsor(sponsorName: string) {
    ...
    return this.http.delete<Sponsor[]>(`${this.sponsorsBaseUrl}/delete`, { params });
  }
  ...
  fetchSponsorDetails(sponsorName: string) {
    ...
    return this.http.get<SponsorLeague[]>(`${this.sponsorsBaseUrl}/detail`, { params });
  }
  ...
  getSponsorshipDetailByLeague(leagueName: string) {
    ...
    return this.http.get<SponsorLeague[]>(`${this.sponsorsBaseUrl}/detailByLeague`, { params });
