...
INSERT INTO `broadcaster` VALUES ('BBC Sport','Gary Lineker','https://www.bbc.co.uk/sport'),('NBC Sports','Arlo White','https://www.nbcsports.com'),('Sky Sports','Martin Tyler','https://www.sky.com/sports');
...
CREATE TABLE `game` (
  ...
  CONSTRAINT `game_ibfk_4` FOREIGN KEY (`broadcaster_channel_name`, `broadcaster_commentator`) REFERENCES `broadcaster` (`channel_name`, `commentator`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `league` VALUES ('La Liga','Spain'),('MLS','United States'),('Premier League','England');
...
INSERT INTO `league_team` VALUES ('La Liga','Athletic Club',2022,0,0,0,0,0),('La Liga','Athletic Club',2023,0,0,0,0,0),('La Liga','Athletic Club',2024,0,0,0,0,0),('La Liga','Atletico Madrid',2022,0,0,0,0,0),('La Liga','Atletico Madrid',2023,0,0,0,0,0),('La Liga','Atletico Madrid',2024,0,0,0,0,0),('La Liga','Barcelona',2022,0,0,0,0,0),('La Liga','Barcelona',2023,0,0,0,0,0),('La Liga','Barcelona',2024,0,0,0,0,0),('La Liga','Espanyol',2022,0,0,0,0,0),('La Liga','Espanyol',2023,0,0,0,0,0),('La Liga','Espanyol',2024,0,0,0,0,0),('La Liga','Real Betis',2022,0,0,0,0,0),('La Liga','Real Betis',2023,0,0,0,0,0),('La Liga','Real Betis',2024,0,0,0,0,0),('La Liga','Real Madrid',2022,0,0,0,0,0),('La Liga','Real Madrid',2023,0,0,0,0,0),('La Liga','Real Madrid',2024,0,0,0,0,0),('La Liga','Real Sociedad',2022,0,0,0,0,0),('La Liga','Real Sociedad',2023,0,0,0,0,0),('La Liga','Real Sociedad',2024,0,0,0,0,0),('La Liga','Sevilla',2022,0,0,0,0,0),('La Liga','Sevilla',2023,0,0,0,0,0),('La Liga','Sevilla',2024,0,0,0,0,0),('La Liga','Valencia',2022,0,0,0,0,0),('La Liga','Valencia',2023,0,0,0,0,0),('La Liga','Valencia',2024,0,0,0,0,0),('La Liga','Villarreal',2022,0,0,0,0,0),('La Liga','Villarreal',2023,0,0,0,0,0),('La Liga','Villarreal',2024,0,0,0,0,0),('MLS','Atlanta United',2022,0,0,0,0,0),('MLS','Atlanta United',2023,0,0,0,0,0),('MLS','Atlanta United',2024,0,0,0,0,0),('MLS','Chicago Fire',2022,0,0,0,0,0),('MLS','Chicago Fire',2023,0,0,0,0,0),('MLS','Chicago Fire',2024,0,0,0,0,0),('MLS','DC United',2022,0,0,0,0,0),('MLS','DC United',2023,0,0,0,0,0),('MLS','DC United',2024,0,0,0,0,0),('MLS','Inter Miami',2022,0,0,0,0,0),('MLS','Inter Miami',2023,0,0,0,0,0),('MLS','Inter Miami',2024,0,0,0,0,0),('MLS','LA Galaxy',2022,0,0,0,0,0),('MLS','LA Galaxy',2023,0,0,0,0,0),('MLS','LA Galaxy',2024,0,0,0,0,0),('MLS','New York Red Bulls',2022,0,0,0,0,0),('MLS','New York Red Bulls',2023,0,0,0,0,0),('MLS','New York Red Bulls',2024,0,0,0,0,0),('MLS','Orlando City',2022,0,0,0,0,0),('MLS','Orlando City',2023,0,0,0,0,0),('MLS','Orlando City',2024,0,0,0,0,0),('MLS','Portland Timbers',2022,0,0,0,0,0),('MLS','Portland Timbers',2023,0,0,0,0,0),('MLS','Portland Timbers',2024,0,0,0,0,0),('MLS','Seattle Sounders',2022,0,0,0,0,0),('MLS','Seattle Sounders',2023,0,0,0,0,0),('MLS','Seattle Sounders',2024,0,0,0,0,0),('MLS','Toronto',2022,0,0,0,0,0),('MLS','Toronto',2023,0,0,0,0,0),('MLS','Toronto',2024,0,0,0,0,0),('Premier League','Arsenal',2022,0,0,0,0,0),('Premier League','Arsenal',2023,0,0,0,0,0),('Premier League','Arsenal',2024,0,0,0,0,0),('Premier League','Aston Villa',2022,0,0,0,0,0),('Premier League','Aston Villa',2023,0,0,0,0,0),('Premier League','Aston Villa',2024,0,0,0,0,0),('Premier League','Brentford',2022,0,0,0,0,0),('Premier League','Brentford',2023,0,0,0,0,0),('Premier League','Brentford',2024,0,0,0,0,0),('Premier League','Chelsea',2022,0,0,0,0,0),('Premier League','Chelsea',2023,0,0,0,0,0),('Premier League','Chelsea',2024,0,0,0,0,0),('Premier League','Fulham',2022,0,0,0,0,0),('Premier League','Fulham',2023,0,0,0,0,0),('Premier League','Fulham',2024,0,0,0,0,0),('Premier League','Liverpool',2022,0,0,0,0,0),('Premier League','Liverpool',2023,0,0,0,0,0),('Premier League','Liverpool',2024,0,0,0,0,0),('Premier League','Manchester City',2022,0,0,0,0,0),('Premier League','Manchester City',2023,0,0,0,0,0),('Premier League','Manchester City',2024,0,0,0,0,0),('Premier League','Manchester United',2022,0,0,0,0,0),('Premier League','Manchester United',2023,0,0,0,0,0),('Premier League','Manchester United',2024,0,0,0,0,0),('Premier League','Newcastle United',2022,0,0,0,0,0),('Premier League','Newcastle United',2023,0,0,0,0,0),('Premier League','Newcastle United',2024,0,0,0,0,0),('Premier League','Tottenham Hotspur',2022,0,0,0,0,0),('Premier League','Tottenham Hotspur',2023,0,0,0,0,0),('Premier League','Tottenham Hotspur',2024,0,0,0,0,0);
...
INSERT INTO `sponsor_league` VALUES ('Adidas','MLS',25000000.00),('Barclays','Premier League',50000000.00),('Coca-Cola','MLS',15000000.00),('Emirates','Premier League',40000000.00),('Rakuten','La Liga',30000000.00),('Santander','La Liga',45000000.00);
...
INSERT INTO `stadium` VALUES ('Anfield','Liverpool','L4 0TH',54074),('Anoeta','San Sebastian','20014',39800),('Audi Field','Washington D.C.','20024',20000),('Benito Villamarin','Seville','41012',60721),('BMO Field','Toronto','M6K 3C3',30000),('Brentford Community Stadium','London','TW8 0NT',17250),('Camp Nou','Barcelona','08028',99354),('Craven Cottage','London','SW6 6HH',25700),('Dignity Health Sports Park','Carson','90746',27000),('DRV PNK Stadium','Fort Lauderdale','33309',19500),('Emirates Stadium','London','N5 1BU',60260),('Estadio de la Ceramica','Villarreal','12540',23500),('Etihad Stadium','Manchester','M11 3FF',53600),('Exploria Stadium','Orlando','32805',25500),('London Stadium','London','E20 2ST',60000),('Lumen Field','Seattle','98134',72000),('Mercedes-Benz Stadium','Atlanta','30313',71000),('Mestalla','Valencia','46010',49865),('Old Trafford','Manchester','M16 0RA',74879),('Providence Park','Portland','97205',25218),('Ramon Sanchez Pizjuan','Seville','41005',43883),('RCDE Stadium','Barcelona','08940',40500),('Red Bull Arena','Harrison','07029',25000),('San Mamés','Bilbao','48013',53289),('Santiago Bernabéu','Madrid','28036',81044),('Soldier Field','Chicago','60605',61500),('St James Park','Newcastle upon Tyne','NE1 4ST',52305),('Stamford Bridge','London','SW6 1HS',40742),('Villa Park','Birmingham','B6 6HE',42682),('Wanda Metropolitano','Madrid','28022',68456);
...
-- Dump completed on 2024-11-17 18:14:27
